...
public class MessageControllerTest {
    ...
    public void mainPageTest() throws Exception {
        this.mockMvc.perform(get("/main"))
                ...
                .andExpect(xpath("/html/body/nav/div[2]").string("Dmitry"));
    }
    ...
    @Test
    public void fileterMessageTest() throws Exception {
    ...
    public void addMessageToListTest() throws Exception {
        MockHttpServletRequestBuilder multipart = multipart("/main")
                ...
                .param("text", "fifth")
                .param("tag", "addMessageToListTestTag")
                .with(csrf());
        ...
        this.mockMvc.perform(multipart)
                ...
                .andExpect(xpath("//*[@id='message-list']/div[@data-id=10]/div/i").string("addMessageToListTestTag"));
    }
}
